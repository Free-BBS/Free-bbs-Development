...
const config = {
  enabled: true,
  allowedKinds: ['activity', 'club', 'knowledge'] as const,
  excludedKeys: [],
    ...
    const candidates = buildCandidates(
      {
        ...
        clubs: [
          { id: 'open', name: '跑团', status: 'active' },
          { id: 'closed', name: '关闭', status: 'archived' },
        ],
        knowledge: [
          {
            id: 'guide',
